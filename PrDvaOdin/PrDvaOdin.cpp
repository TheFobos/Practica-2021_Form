...
// PrDvaOdin.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPrDvaOdinApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CPrDvaOdinApp

CPrDvaOdinApp::CPrDvaOdinApp()
{
...
// Единственный объект CPrDvaOdinApp

CPrDvaOdinApp theApp;


// инициализация CPrDvaOdinApp

BOOL CPrDvaOdinApp::InitInstance()
{
	AfxInitRichEdit2();
